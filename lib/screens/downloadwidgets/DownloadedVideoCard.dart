...
//                              vertical: 5,horizontal: 12
                              vertical:  screenWidth*0.01216,horizontal: screenWidth*0.02919
                          ),
                          decoration: BoxDecoration(
                            color:redthemedcolor,
                            borderRadius: BorderRadius.all(Radius.circular(30)),
                            boxShadow: [
                              BoxShadow(color: Color(0xffFF0000).withOpacity(0.48),
...
//width:108,height:27,
        ...
        decoration: BoxDecoration(
          color: royalbluethemedcolor,
          borderRadius: BorderRadius.all(Radius.circular(30)),
          boxShadow: [BoxShadow(color: Color(0xff0062FF).withOpacity(0.28),
            offset: Offset(0,3),blurRadius: 10
          )]
        ),
        child: Center(
          child: Text("Open Video",style: TextStyle(
            fontFamily: proximanovaregular,
            color: Colors.white,
      //      fontSize: 13
