...
Container(
 ...
 //   fontSize: 19
  fontSize: screenwidth*0.0462
      ...
      Container(
        child: Text("0 files",style: TextStyle(
...
Widget emptydownloads(BuildContext context){
  ...
  return Container(
    child: Column(
      ...
      children:[
        SvgPicture.asset("assets/images/nodownloads.svg",
        width: screenwidth*0.669,),
        Container(
          child: Text("No downloads yet",style: TextStyle(
            fontFamily: proximanovaregular,
            color: blackthemedcolor,
        ...
        Container(
          child: Text("Copy and paste link to see download options",
...
//           vertical: 6,horizontal: 14
           vertical: screenwidth*0.0145,horizontal: screenwidth*0.03406
       ),
